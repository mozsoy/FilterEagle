...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = "FilterEagle.Main";
    ...
    public static final String ACTION_RULES_CHANGED = "com.master.metehan.filtereagle.ACTION_RULES_CHANGED";
    public static final String ACTION_QUEUE_CHANGED = "com.master.metehan.filtereagle.ACTION_QUEUE_CHANGED";
