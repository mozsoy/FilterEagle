...
public class ActivityForwardApproval extends Activity {
    private static final String TAG = "FilterEagle.Forward";
    private static final String ACTION_START_PORT_FORWARD = "com.master.metehan.filtereagle.START_PORT_FORWARD";
    private static final String ACTION_STOP_PORT_FORWARD = "com.master.metehan.filtereagle.STOP_PORT_FORWARD";
