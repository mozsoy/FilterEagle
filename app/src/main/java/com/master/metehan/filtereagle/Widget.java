...
public class Widget extends AppWidgetProvider {
    private static final String TAG = "FilterEagle.Widget";

    private static final String INTENT_ON = "com.master.metehan.filtereagle.APPWIDGET_ON";
    private static final String INTENT_OFF = "com.master.metehan.filtereagle.APPWIDGET_OFF";
